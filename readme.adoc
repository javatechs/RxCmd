...
cd /etc/init.d
-----------------------------------------------------
* Download hhttps://github.com/javatechs/RxCmd/blob/master/daemon-rxcmd.sh[This File] to the /etc/init.d folder you're currently in.  An easy way to do that would be to use wget:
-----
