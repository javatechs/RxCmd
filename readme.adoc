...
cd /etc/init.d
-----------------------------------------------------
* Download https://github.com/javatechs/RxCmd/daemon-rxcmd.sh[This File] to the /etc/init.d folder you're currently in.  An easy way to do that would be to use wget:
-----
